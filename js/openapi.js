(function(w) {
  ...
  if (!VK.Goal) {
     ...
     * @public
     */
    VK.Goal = function (conversionName, parameters) {
      if (!VK.Retargeting.pixelCode) {
        console.error('Not found initialized pixel. Use VK.Retargeting.Init to initialize pixel');
        return;
      }
